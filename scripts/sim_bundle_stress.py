...
"""
결합(bundle-v3) 대규모 랜덤 스트레스 시뮬레이션 — 의도 변화 적절성·이상 케이스 탐지.
...
MAX_ACT = 30
STUCK_N = 15
GENERIC = set()  # bundle: 범용 intent 없음 (E2 N/A)
...
def run():
    ...
    print("=" * 64)
    print(f"결합 스트레스 시뮬 완료 — {dt/60:.1f}분 (설문 {N_SURVEY:,} + 행동 {N_SESS:,}×≤{MAX_ACT})")
    print("=" * 64)
