...
PERSONAS = [
    {
        ...
        "answer_dist": {
            ...
            "Q9": {"A": 0.5, "B": 0.5}, "Q10": {"B": 0.5, "C": 0.5},
    ...
    },
    {
        ...
        "answer_dist": {
            ...
            "Q9": {"B": 0.4, "C": 0.4, "D": 0.2}, "Q10": {"B": 0.5, "C": 0.5},
    ...
    },
    {
        ...
        "answer_dist": {
            ...
            "Q9": {"A": 0.3, "B": 0.4, "C": 0.3}, "Q10": {"A": 0.6, "B": 0.4},
            "Q11": {"A": 0.5, "B": 0.5}, "Q12": {"A": 0.2, "B": 0.4, "C": 0.4},
        },
    ...
    },
    {
        ...
        "answer_dist": {
            ...
            "Q9": {"B": 0.4, "C": 0.4, "D": 0.2}, "Q10": {"B": 0.5, "C": 0.5},
            "Q11": {"A": 0.3, "B": 0.3, "F": 0.4}, "Q12": {"B": 0.5, "C": 0.5},
        },
    ...
    },
    {
        ...
        "answer_dist": {
            ...
            "Q11": {"A": 0.3, "C": 0.3, "D": 0.2, "E": 0.2}, "Q12": {"A": 0.2, "B": 0.4, "C": 0.4},
        },
        "action_seqs": [["1-E", "2-E2"], ["1-E", "2-E2"], ["1-E", "2-E1"], ["1-E", "2-E2", "BACK", "1-E", "2-E2", "EXIT"]],
    ...
    },
    {
        ...
        "answer_dist": {
            ...
            "Q11": {"B": 0.4, "F": 0.6}, "Q12": {"C": 0.7, "B": 0.3},
        },
    ...
    },
    {
        ...
        "answer_dist": {
            ...
            "Q9": {"A": 0.3, "B": 0.4, "C": 0.3}, "Q10": {"B": 0.5, "C": 0.5},
            "Q11": {"C": 0.3, "D": 0.3, "F": 0.4}, "Q12": {"C": 0.8, "B": 0.2},
        },
    ...
    },
    {
        ...
        "answer_dist": {
            ...
            "Q9": {"A": 0.5, "B": 0.4, "C": 0.1}, "Q10": {"A": 0.5, "B": 0.5},
            "Q11": {"A": 0.6, "B": 0.4}, "Q12": {"A": 0.3, "B": 0.5, "C": 0.2},
        },
        "action_seqs": [["1-A", "2-A1"], ["1-C", "2-C5"], ["1-A", "2-A3"], ["1-E", "2-E2"]],
...
def main():
    ...
    # Q9(모바일 외 통신 지출)는 Q5=모바일만(A) 고객에겐 0 — 런타임 조건부 숨김과 동일 정합성
    def _q9_fixup(a):
        if a.get("Q5") == "A":
            a["Q9"] = "A"   # non_mobile_cost_gap = 0
    ...
    rows = build_samples(
        ...
        entity_intents=entity_intents, cust_prefix="BC", answer_fixup=_q9_fixup,
    )
