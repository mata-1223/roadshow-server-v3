...
TAX: list[dict] = [
    ...
    dict(key="131", name="신규 결합 가입 혜택 확인", type="Model",
    ...
    dict(key="141", name="온라인 결합 가입 검토", type="Rule",
    ...
    dict(key="142", name="상담 기반 결합 가입 검토", type="Rule",
         features=["Bundle Opportunity Index", "Acquisition Score"],
    ...
    dict(key="143", name="매장 방문 결합 가입 검토", type="Model",
         features=["Bundle Opportunity Index", "Acquisition Score"],
         entities=[],
    ...
    # ── L1=2 할인 최적화 ─────────────────────────────────────
    dict(key="211", name="현재 결합 혜택 확인", type="Rule",
    ...
    dict(key="221", name="추가 결합 할인 가능 여부 확인", type="Rule",
    ...
    dict(key="234", name="미사용 결합 혜택 확인", type="Rule",
         features=["Benefit Engagement Index", "benefit_utilization"],
    ...
    # ── L1=4 유지/락인 ───────────────────────────────────────
    dict(key="411", name="결합 약정 상태·연장 혜택 확인", type="Rule",
    ...
    dict(key="412", name="결합 재약정 혜택 비교", type="Model",
    ...
    dict(key="421", name="결합 장기 고객 혜택 확인", type="Rule",
    ...
    dict(key="431", name="요금제 변경 시 결합 영향 확인", type="Model",
    ...
    dict(key="521", name="결합 혜택 부족 체감", type="Model",
    ...
    dict(key="523", name="결합 통신비 부담 증가", type="Model",
